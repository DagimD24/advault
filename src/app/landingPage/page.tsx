    ...
    <div className="bg-[#F3F4F6] min-h-screen font-sans text-black overflow-x-hidden selection:bg-lime-400 selection:text-black">
      ...
      <nav className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between relative z-50">
        ...
        <div className="flex gap-4">
            <button onClick={handleEnter} className="hidden sm:block text-sm font-semibold px-4 py-2 hover:bg-gray-200 rounded-full transition-colors">
                Log in
            </button>
            <button onClick={handleEnter} className="text-sm font-bold bg-black text-white px-6 py-3 rounded-full hover:bg-lime-400 hover:text-black hover:scale-105 transition-all duration-300 flex items-center gap-2 shadow-xl shadow-lime-400/20">
                Sign up
                <ArrowRight size={16} />
            </button>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8 animate-fade-in-up">
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        <button onClick={handleEnter} className="h-14 px-8 rounded-full bg-lime-400 text-black font-bold text-lg hover:bg-lime-300 transition-colors flex items-center gap-2 shadow-lg shadow-lime-400/30 transform hover:-translate-y-1">
                            Start Earning
                            <MoveUpRight size={20} />
                        </button>
        ...
        <div className="grid md:grid-cols-3 gap-6 h-auto md:h-[500px]">
            <div className="md:col-span-2 bg-gray-50 rounded-[2.5rem] p-10 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-500">
                <div className="relative z-10 max-w-sm">
                    ...
                    <button onClick={handleEnter} className="flex items-center gap-2 font-bold text-black group-hover:gap-4 transition-all">
      ...
      <div className="bg-gray-900 text-gray-100 py-24 rounded-t-[3rem] mx-2 mt-10 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
            ...
            <div className="flex justify-center gap-4">
                 <button onClick={handleEnter} className="bg-gray-100 text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-lime-400 hover:scale-105 transition-all duration-300">
                    Join Marketplace
                 </button>
            </div>
        </div>
