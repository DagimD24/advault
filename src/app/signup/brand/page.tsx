    ...
    const form = useForm({
        ...
        onSubmit: async ({ value }) => {
            ...
            try {
                ...
                // Step 1: Sign up with Better Auth (email/password)
                ...
                if (authResult.error) {
                    setServerError(authResult.error.message || "Failed to create account");
                    return;
                }

                // Step 2: Create brand profile in Convex
                if (authResult.data?.user?.id) {
                    ...
                    setServerError("Account created but failed to create profile");
                }
            } catch (err: any) {
            ...
            <main className="flex-1 flex items-center justify-center px-4 pb-16 relative z-10">
                <div className="w-full max-w-lg">
                    ...
                    >
                        ...
                        {/* Social Sign-On for Step 1 only */}
                        {step === 1 && (
                            <>
                                {/* Divider */}
                                <div className="relative my-6">
                                    ...
                                    <div className="relative flex justify-center text-xs">
                                        <span className="px-3 bg-white text-gray-500 font-bold">Or sign up with</span>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    <button
                                        ...
                                        className="w-full py-3.5 px-5 bg-gray-50 border-2 border-gray-200/50 text-gray-700 font-bold rounded-[1.5rem] hover:bg-lime-50 hover:border-lime-400 transition-all duration-300 flex items-center justify-center gap-2.5 text-sm group shadow-sm hover:shadow-md"
                                    >
                                    ...
                                    >
                                        ...
                                        <span className="group-hover:text-black transition-colors">Continue with TikTok</span>
                                    </button>
                                </div>
                            </>
                        )}
